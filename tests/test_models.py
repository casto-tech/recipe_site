...
class TestRecipeModel:
    ...
    def test_get_ingredients_list_splits_lines(self, recipe_factory):
        recipe = recipe_factory(ingredients="1 cup flour\n2 eggs\n1 tsp salt\n")
    ...
    def test_get_directions_list_splits_lines(self, recipe_factory):
        recipe = recipe_factory(directions="Mix ingredients.\nPour into pan.\nBake 30 minutes.")
    ...
    def test_ordering_newest_first(self, recipe_factory):
        ...
        recipes = list(__import__("recipes.models", fromlist=["Recipe"]).Recipe.objects.all())
